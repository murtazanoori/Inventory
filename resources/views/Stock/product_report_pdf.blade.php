                                    ...
                                    <table class="table table-bordered border text-nowrap mb-0" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $product->supplier_details->name }} </td>
                                                <td class="text-center">
                                                    {{ $product->unit_details ? $product->unit_details->unit : '-' }} </td>
                                                <td class="text-center"> {{ $product->category_details->category }} </td>
