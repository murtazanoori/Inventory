                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="md-3">
                                            ...
                                            <i
                                                class="btn btn-dark btn-rounded waves-effect waves-light fa fa-plus-circle addeventmore">
                                                Add More</i>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('purchase.store') }}">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-success" id="storeButton"> Purchase
                                            Store</button>
    ...
    <script id="document-template" type="text/x-handlebars-template">
        ...
        <tr class="delete_add_more_item" id="delete_add_more_item">
         ...
         <td>
             ...
             <td>
                <i class="btn btn-danger btn-sm fa fa-trash removeeventmore"></i>
            </td>
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, v) {
                            html += '<option value=" ' + v.category_id + ' "> ' + v
                                .category_details.category + '</option>';
                        });
