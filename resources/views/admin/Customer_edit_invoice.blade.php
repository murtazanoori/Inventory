            ...
            <div class="main-container container-fluid">
                ...
                <div class="row" style=" margin-top: 6rem;">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('customer.DailycustomerReportPdf') }}"
                                    class="btn btn-danger fa fa-arrow-circle-left" style="float: right; margin-right:5px;">
                                    Back</a>
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive push">
                                    <form action="{{ route('customer.updateinvoice', $payment->invoice_id) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <table class="table table-bordered table-hover mb-0 text-nowrap">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="new_paid_amount" id="new_paid_amount"
                                                        value="{{ $payment->due_amount }}">
                                                    <td class="thick-line text-center">${{ $payment->discount_amount }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="thick-line"></td>
                                ...
                                <button type="submit" class="btn btn-success" style="float:left; ">Update
                                    Invoice</button>
                                </form>
