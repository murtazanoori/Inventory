        ...
        <div class="side-app">
            ...
            <div class="card" style=" margin-top:9rem; ">
                    ...
                    <form method="post" action="{{ route('customer.update') }}" id="myForm">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="department" aria-describedby="basic-addon1"
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" type="submit" value="Update customer">Submit</button>
                </div>
                </form>
            </div>
        </div>
